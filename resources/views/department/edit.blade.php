                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('/departments') }}">Jenjang Jabatan</a></li>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h2 class="mb-0">Ubah Jenjang Jabatan</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form autocomplete="off" method="post" action="/departments/{{ $department->id }}"
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        ...
                                        placeholder="Nama Jenjang Jabatan">
                                    @error('name')
                                    ...
                                    <select class="form-control @error('organization') is-invalid @enderror"
                                        ...
                                        @foreach ($organizations as $organization)
                                            <option value="{{ $organization->id }}"
                                                {{ old('organization', $department->organization->id) == $organization->id ? 'selected' : '' }}>
