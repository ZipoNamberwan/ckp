                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ url('/departments/create') }}" class="btn btn-primary btn-round btn-icon mb-2"
                                    data-toggle="tooltip" data-original-title="Tambah Jenjang Jabatan">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($department->organization)
                                                {{ $department->organization->name }} @endif
                                        </td>
                                        <td>
                                            ...
                                            <form class="d-inline" id="formdelete{{ $department->id }}"
                                                name="formdelete{{ $department->id }}"
                                                onsubmit="deletedepartment('{{ $department->id }}','{{ $department->name }}')"
                                                method="POST" action="{{ url('/departments/' . $department->id) }}">
                                                @method('delete')
                                                @csrf
                                                <button class="btn btn-icon btn-outline-danger btn-sm" type="submit"
                                                    data-toggle="tooltip" data-original-title="Hapus Jenjang Jabatan">
