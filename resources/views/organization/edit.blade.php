    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <form autocomplete="off" method="post" action="/organizations/{{$organization->id}}" class="needs-validation" enctype="multipart/form-data" novalidate>
                        @method('patch')
                        @csrf
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                <label class="form-control-label" for="name">Nama Unit Kerja</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{@old('name', $organization->name)}}" id="name" name="name" placeholder="Nama Unit Kerja">
                                @error('name')
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{$organization->parent->name}}" disabled>
                            </div>
                        </div>
