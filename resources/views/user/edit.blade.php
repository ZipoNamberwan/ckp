                    ...
                    <div class="card-body">
                        <div class="col-md-4">
                            <form autocomplete="off" method="post" action="/users/{{ $user->id }}"
                                ...
                                <div class="form-row">
                                    <div class="col mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                            value="{{ @old('nip', $user->nip) }}" id="nip" name="nip" placeholder="NIP Baru">
                                        @error('nip')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <select class="form-control @error('department') is-invalid @enderror"
                                            ...
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->id }}"
                                                    {{ old('department', $user->department->id) == $department->id ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control @error('assessor') is-invalid @enderror"
                                            ...
                                            @foreach ($users as $assessor)
                                                <option value="{{ $assessor->id }}"
                                                    {{ old('assessor', $user->assessor_id) == $assessor->id ? 'selected' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="col mb-3">
                                        ...
                                        <select class="form-control @error('role') is-invalid @enderror"
                                            ...
                                            <option @if ((old('role') == 'supervisor') | $user->hasRole('supervisor')) selected @endif value="supervisor">Supervisor
                                            </option>
                                            <option @if ((old('role') == 'user') | $user->hasRole('user')) selected @endif value="user">User</option>
                                        </select>
                                        @error('role')
                                            <div class="error-feedback">
                                                {{ $message }}
                                ...
                                <div class="form-row">
                                    <div class="col"> <label class="form-control-label" for="changepassword">Ganti
                                            Password?</label>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col mb-2">
                                        <label class="custom-toggle">
                                            <input type="checkbox" onchange="ischangepassword()" name="changepassword"
                                                id="changepassword" @if (old('changepassword')) checked @endif>
                                ...
                                <div class="form-row">
                                    <div class="col mb-3">
                                        ...
                                        <input type="password"
                                            ...
                                            placeholder="Konfirmasi Password" disabled>
