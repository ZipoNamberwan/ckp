    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-4">
                        <form autocomplete="off" method="post"  action="/users" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="form-row">
                                <div class="col mb-3">
                            ...
                            <div class="form-row">
                                <div class="col mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{@old('name')}}" id="name" name="name" placeholder="Nama">
                                    @error('name')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
