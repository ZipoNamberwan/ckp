        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <form id="formupdate" autocomplete="off" method="post" action="/ckps/ckpr/{{ $ckp->id }}"
                                        ...
                                        <table class="table" width="90%" id="ckp-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-1"><input class="form-control" type="number" min="0"
                                                            name="activityreal[]" @if (old('activityreal.0')) value="{{ old('activityreal.0') }}" @elseif(count($ckp->activities) > 0) value="{{ $ckp->activities[0]->real }}" @endif @if ($ckp->status_id == '3' || $ckp->status_id == '5' || $ckp->status_id == '6')
                                                        disabled @endif>
                                                ...
                                                @if (old('activityname'))
                                                    @for ($i = 1; $i < count(old('activityname')); $i++) @if (old('activitytype.' . $i) == 'main') <tr>
                                                        ...
                                                        <td class="px-1"><input
                                                        class="form-control" type="number"
                                                        min="0" name="activityreal[]"
                                                        value="{{ old('activityreal.' . $i) }}">
                                                    ...
                                                    @for ($i = 1; $i < count($ckp->activities); $i++)
                                                        @if ($ckp->activities[$i]->type == 'main')
                                                            <tr>
                                                                ...
                                                                <td class="px-1"><input class="form-control" type="number"
                                                                        min="0" name="activityreal[]"
                                                                        value="{{ $ckp->activities[$i]->real }}" @if ($ckp->status_id == '3' || $ckp->status_id == '5' || $ckp->status_id == '6') disabled @endif>
                                                                </td>
                                                                <td class="px-1"><input class="form-control" type="text"
                                                                        disabled></td>
                                                                <td class="px-1"><input class="form-control" type="text"
                                                ...
                                                <tr>
                                                    <td colspan="9">
                                                        ...
                                                        <button type="button" class="btn btn-secondary btn-sm"
                                                            onclick="getactivity('main')" data-toggle="modal"
                                                            data-target="#modal-default" @if ($ckp->status_id == '3' || $ckp->status_id == '5' || $ckp->status_id == '6') disabled @endif>
                                                            <span class="btn-inner--icon"><i
                                                ...
                                                <tr>
                                                    <td colspan="9">
                                                        ...
                                                        <button type="button" class="btn btn-secondary btn-sm"
                                                            onclick="getactivity('additional')" data-toggle="modal"
                                                            data-target="#modal-default" @if ($ckp->status_id == '3' || $ckp->status_id == '5' || $ckp->status_id == '6') disabled @endif>
                                                            <span class="btn-inner--icon"><i
                                                                    class="fas fa-mobile-alt"></i></span>
                                                            <span class="btn-inner--text">Tambah Dari Laporan WFH
...
@section('optionaljs')
    ...
    <script>
        function addactivity(type, namakegiatan, satuankegiatan) {
            ...
            cell8.innerHTML = "<input class='form-control' type='number' name='activitycredit[]'>";
